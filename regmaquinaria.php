					...
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
							       ...
							       <section>
                                       <center>
                                       	<h3>Regirtro Maquinaria</h3>

													<form method="post" action="RegistroMaq.php">
                                                        ...
                                                        <div class="row uniform">
                                                         ...
                                                         <div class="row uniform">
															<div class="6u 12u$(xsmall)">
																<input type="text" name="tipo"  placeholder="tipo de maquinaria" />
															</div>
                                                        </div>
                                                        <section>
									<div>
						<div  style=" margin:2% 3% 3% 3%; text-align: center;">
											...
											<table class="table table-bordered"  border="5px" style=" border-collapse: separate; border-spacing: 2px; background-image: url(img/fondo.jpg); bottom left repeat-x; color:black;">
												<thead>
													<th style="background-image: url(img/images.jpg); text-align: center;">Id_tipo</th>
													<th style="background-image: url(img/images.jpg); text-align: center;">Decripcion</th>
												</thead>
